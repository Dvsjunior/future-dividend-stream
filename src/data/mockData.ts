...
export const fundosImobiliarios: FundoImobiliario[] = [
  { ticker: 'MXRF11', name: 'Maxi Renda', price: 10.25, dividendYield: 12.5, lastDividend: 0.10, dataCom: '2026-04-15', dataPayment: '2026-04-25', pvp: 0.98, sector: 'Papel' },
  { ticker: 'HGLG11', name: 'CSHG Logística', price: 162.50, dividendYield: 8.2, lastDividend: 1.10, dataCom: '2026-04-10', dataPayment: '2026-04-18', pvp: 1.02, sector: 'Logística' },
  { ticker: 'KNRI11', name: 'Kinea Renda', price: 135.80, dividendYield: 7.8, lastDividend: 0.85, dataCom: '2026-04-12', dataPayment: '2026-04-22', pvp: 0.95, sector: 'Híbrido' },
  { ticker: 'XPML11', name: 'XP Malls', price: 98.40, dividendYield: 9.1, lastDividend: 0.75, dataCom: '2026-04-08', dataPayment: '2026-04-16', pvp: 1.05, sector: 'Shopping' },
  { ticker: 'VISC11', name: 'Vinci Shopping', price: 105.20, dividendYield: 8.5, lastDividend: 0.72, dataCom: '2026-05-10', dataPayment: '2026-05-20', pvp: 0.97, sector: 'Shopping' },
  { ticker: 'BTLG11', name: 'BTG Logística', price: 98.60, dividendYield: 9.3, lastDividend: 0.76, dataCom: '2026-05-05', dataPayment: '2026-05-15', pvp: 0.99, sector: 'Logística' },
  { ticker: 'PVBI11', name: 'VBI Prime', price: 82.30, dividendYield: 8.8, lastDividend: 0.60, dataCom: '2026-04-20', dataPayment: '2026-04-30', pvp: 0.93, sector: 'Lajes Corporativas' },
  { ticker: 'IRDM11', name: 'Iridium Recebíveis', price: 78.90, dividendYield: 13.2, lastDividend: 0.87, dataCom: '2026-04-14', dataPayment: '2026-04-24', pvp: 1.01, sector: 'Papel' },
  { ticker: 'CPTS11', name: 'Capitânia Securities', price: 86.50, dividendYield: 11.8, lastDividend: 0.85, dataCom: '2026-05-12', dataPayment: '2026-05-22', pvp: 0.96, sector: 'Papel' },
  { ticker: 'RECR11', name: 'REC Recebíveis', price: 82.10, dividendYield: 12.1, lastDividend: 0.82, dataCom: '2026-04-18', dataPayment: '2026-04-28', pvp: 0.94, sector: 'Papel' },
];
